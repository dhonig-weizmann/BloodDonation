...
%%
% subjData(7)=[]; %have short after (*technical issue)
...
cohort=repmat({'control'},size(Y));
%%
T1= table(X,Y,participant',weight_vec_con',cohort,'VariableNames',{'X','session','participant','weight','cohort'});
%%
save('Controls_table.mat','T1');